...
SRC = ROOT / "restavraciya-obektov-E.pptx"
OUT = ROOT / "build/pptx_shots_e"; OUT.mkdir(parents=True, exist_ok=True)
...
FONTS = {
    ...
    ("Noto Sans SemiBold", False): "/root/.fonts/NotoSans-SemiBold.ttf",
    ("Noto Sans SemiBold", True): "/root/.fonts/NotoSans-SemiBold.ttf",
}
